...
import 'package:app_user/app/backend/parse/add_card_parse.dart';
import 'package:app_user/app/backend/parse/add_review_parse.dart';
import 'package:app_user/app/backend/parse/address_list_parse.dart';
import 'package:app_user/app/backend/parse/address_parse.dart';
import 'package:app_user/app/backend/parse/all_categories_parse.dart';
import 'package:app_user/app/backend/parse/app_pages_parse.dart';
import 'package:app_user/app/backend/parse/appointment_detail_parse.dart';
import 'package:app_user/app/backend/parse/booking_parse.dart';
import 'package:app_user/app/backend/parse/cart_parse.dart';
import 'package:app_user/app/backend/parse/categories_list_parse.dart';
import 'package:app_user/app/backend/parse/categories_parse.dart';
import 'package:app_user/app/backend/parse/chat_parse.dart';
import 'package:app_user/app/backend/parse/checkout_parse.dart';
import 'package:app_user/app/backend/parse/choose_location_parse.dart';
import 'package:app_user/app/backend/parse/complaints_parse.dart';
import 'package:app_user/app/backend/parse/contact_us_parse.dart';
import 'package:app_user/app/backend/parse/coupon_parse.dart';
...
import 'package:app_user/app/backend/parse/find_location_parse.dart';
import 'package:app_user/app/backend/parse/firebase_parse.dart';
import 'package:app_user/app/backend/parse/home_parse.dart';
import 'package:app_user/app/backend/parse/individual_categories_parse.dart';
import 'package:app_user/app/backend/parse/individual_checkout_parse.dart';
import 'package:app_user/app/backend/parse/individual_list_parse.dart';
import 'package:app_user/app/backend/parse/individual_packages_parse.dart';
import 'package:app_user/app/backend/parse/individual_payment_parse.dart';
import 'package:app_user/app/backend/parse/individual_slot_parse.dart';
import 'package:app_user/app/backend/parse/intro_parse.dart';
import 'package:app_user/app/backend/parse/languages_parse.dart';
import 'package:app_user/app/backend/parse/login_parse.dart';
import 'package:app_user/app/backend/parse/near_parse.dart';
import 'package:app_user/app/backend/parse/new_address_parse.dart';
import 'package:app_user/app/backend/parse/notification_parse.dart';
import 'package:app_user/app/backend/parse/packages_details_parse.dart';
import 'package:app_user/app/backend/parse/payment_parse.dart';
import 'package:app_user/app/backend/parse/product_cart_parse.dart';
import 'package:app_user/app/backend/parse/product_order_detail_parse.dart';
import 'package:app_user/app/backend/parse/product_order_parse.dart';
import 'package:app_user/app/backend/parse/product_payment_parse.dart';
import 'package:app_user/app/backend/parse/products_details_parse.dart';
import 'package:app_user/app/backend/parse/products_parse.dart';
import 'package:app_user/app/backend/parse/refer_and_earn_parse.dart';
import 'package:app_user/app/backend/parse/register_parse.dart';
import 'package:app_user/app/backend/parse/reset_password_parse.dart';
import 'package:app_user/app/backend/parse/search_parse.dart';
import 'package:app_user/app/backend/parse/selected_services_parse.dart';
import 'package:app_user/app/backend/parse/service_cart_parse.dart';
import 'package:app_user/app/backend/parse/services_parse.dart';
import 'package:app_user/app/backend/parse/sidemenu_parse.dart';
import 'package:app_user/app/backend/parse/slot_parse.dart';
...
import 'package:app_user/app/backend/parse/stripe_pay_parse.dart';
import 'package:app_user/app/backend/parse/stripe_pay_product_parse.dart';
import 'package:app_user/app/backend/parse/tabs_parse.dart';
import 'package:app_user/app/backend/parse/top_offers_parse.dart';
import 'package:app_user/app/backend/parse/top_packages_parse.dart';
import 'package:app_user/app/backend/parse/top_products_parse.dart';
import 'package:app_user/app/backend/parse/top_specialist_parse.dart';
import 'package:app_user/app/backend/parse/wallet_parse.dart';
import 'package:app_user/app/backend/parse/web_payment_parse.dart';
import 'package:app_user/app/backend/parse/web_product_payment_parse.dart';
...
class MainBinding extends Bindings {
  ...
  Future<void> dependencies() async {
    ...
    Get.lazyPut(() => FavoriteController(parser: Get.find()));
