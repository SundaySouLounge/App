...
class ChatConversionModel {
  ...
  Map<String, dynamic> toJson() {
   ...
   static ChatConversionModel createWithZeroLastMessage({
    String? senderFirstName,
    int? senderId,
    String? receiverName,
    int? receiverId,
    ...
    return ChatConversionModel(
      senderFirstName: senderFirstName,
      senderId: senderId,
      receiverName: receiverName,
      receiverId: receiverId,
      senderLastName: senderLastName,
      senderCover: senderCover,
      receiverLastName: receiverLastName,
      receiverCover: receiverCover,
      senderType: senderType,
      receiverType: receiverType,
      lastMessage: '0',
      lastMessageType: null, // You can set this to a default value if needed
      updatedAt: updatedAt,
    );
  }
}
