                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: value.venueTextEditor,
                          onChanged: (String txt) {
                            SharedPreferences.getInstance().then((prefs) {
                              prefs.setString('venueName', txt);
                            });
                          },
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (String txt) {
                            SharedPreferences.getInstance().then((prefs) {
                              prefs.setString('venueAddress', txt);
                            });
                          },
                          cursorColor: ThemeProvider.appColor,
                          decoration: InputDecoration(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                ...
                                child: DropdownButtonFormField<String>(
                                  value: value.extraTextEditor.text,
                                  ...
                                  onChanged: (String? newValue) {
                                    if (newValue != null) {
                                      ...
                                      value.extraTextEditor.text = newValue;
                                    }
                                  },
                                  decoration: InputDecoration(
                                    labelStyle: const TextStyle(
