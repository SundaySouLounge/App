...
class RegisterController extends GetxController implements GetxService {
  ...
  Future<void> onRegister() async {
    if (firstNameTextEditor.text == '' ||
        ...
        venueName.text == '' ||
        venueName.text.isEmpty ||
        venueAddress.text == '' ||
        venueAddress.text.isEmpty ||
        ...
        referralCodeTextEditor.text.isEmpty) {
  ...
  Future<void> createAccount() async {
    var body = {
      ...
      "venue_name": venueName.text,
      "venue_address": venueAddress.text,
      "last_name": lastNameTextEditor.text,
      "mobile": mobileTextEditor.text,
      "country_code": countryCode,
      "extra_field": referralCodeTextEditor.text,
      "password_second": passwordTextEditor.text,
      'fcm_token': parser.getFcmToken(),
    };
    print('referralCodeTextEditor.text type: ${referralCodeTextEditor.text.runtimeType}');
    Get.dialog(
        SimpleDialog(
          children: [
            Row(
    ...
    if (response.statusCode == 200) {
      ...
      parser.saveInfo(
        ...
        myMap['user']['venue_name'].toString(),
        myMap['user']['venue_address'].toString(),
        myMap['user']['extra_field'].toString(),
        myMap['user']['password_second'].toString(),
      );
