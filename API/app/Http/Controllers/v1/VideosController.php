...
class VideosController extends Controller
{
    ...
    public function getByUID(Request $request){
        ...
        $data = Videos::where('uid',$request->id)->first();
    ...
    public function getMyVideos(Request $request){
        ...
        $data = Videos::where('uid',$request->id)->get();
        if (is_null($data)) {
            $response = [
                'success' => false,
                'message' => 'Data not found.',
    ...
    public function update(Request $request){
        ...
        $data = Videos::find($request->id)->update($request->all());
    ...
    public function getActiveItem(Request $request){
        $data = Videos::where('status',1)->get();
