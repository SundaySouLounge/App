...
use App\Http\Controllers\v1\EventContractController;
use App\Http\Controllers\v1\UnavailableDateController;
...
use App\Http\Controllers\v1\VideosController;
use App\Http\Controllers\v1\CalendarEventsController;
...
Route::prefix('/v1')->group(function () {
    ...
    Route::group(['middleware' => ['jwt', 'jwt.auth']], function () {
        ...
        Route::post('salon/getByUID', [SalonController::class, 'getByUID']);
        ...
        // Freelancer Video Routes
        Route::get('freelancer_videos/getAll', [VideosController::class, 'getAll']);
        Route::post('freelancer_videos/create', [VideosController::class, 'save']);
        Route::post('freelancer_videos/update', [VideosController::class, 'update']);
        Route::post('freelancer_videos/remove', [VideosController::class, 'delete']);
        Route::post('freelancer_videos/getById', [VideosController::class, 'getByUID']);
        Route::post('freelancer_videos/getVideoById', [VideosController::class, 'getVideoById']);
        Route::post('freelancer_videos/getMyVideos', [VideosController::class, 'getMyVideos']);


        // Calendar Events Routes
        Route::get('calendar_events/getAll', [CalendarEventsController::class, 'getAll']);
        Route::post('calendar_events/create', [CalendarEventsController::class, 'save']);
        Route::post('calendar_events/update', [CalendarEventsController::class, 'update']);
        Route::post('calendar_events/remove', [CalendarEventsController::class, 'delete']);
        Route::post('calendar_events/getEventById', [CalendarEventsController::class, 'getEventById']);
        Route::post('calendar_events/getMyEvents', [CalendarEventsController::class, 'getMyEvents']);
        ...
        Route::post('notification/sendToAllUsers', [PushNotificationController::class, 'sendToAllUsers']);
        Route::post('notification/sendToUsers', [PushNotificationController::class, 'sendToUsers']);
        Route::post('notification/sendToStores', [PushNotificationController::class, 'sendToStores']);
        Route::post('notification/sendToSalon', [PushNotificationController::class, 'sendToSalon']);
        Route::post('notification/sendNotification', [PushNotificationController::class, 'sendNotification']);
        Route::get('notification/getMyNotificationData', [PushNotificationController::class, 'getMyNotificationData']);
        Route::get('notification/getAllNotifications', [PushNotificationController::class, 'getAllNotifications']);
        Route::post('notification/deletePushNotification', [PushNotificationController::class, 'deletePushNotification']);
        ...
        Route::post('users/sendMailToIndividual', [AuthController::class, 'sendMailToIndividual']);
        ...
        Route::post('users/getFavoriteData', [AuthController::class, 'getFavoriteData']);
        Route::post('users/updateFavoriteIndividual', [AuthController::class, 'updateFavoriteIndividual']);
        Route::post('users/deleteFavoriteIndividual', [AuthController::class, 'deleteFavoriteIndividual']);
        Route::post('users/updateFavoriteSalon', [AuthController::class, 'updateFavoriteSalon']);
        Route::post('users/deleteFavoriteSalon', [AuthController::class, 'deleteFavoriteSalon']);
        ...
        Route::post('event_contract/createEventContract', [EventContractController::class, 'save']);
        Route::post('event_contract/update', [EventContractController::class, 'update']);
        Route::get('event_contract/getMyEventContracts', [EventContractController::class, 'getMyEventContracts']);
        Route::post('unavailable_date/getUnavailableDatesByUid', [UnavailableDateController::class, 'getUnavailableDatesByUid']);
        Route::post('unavailable_date/updateUnavailableDatesByUid', [UnavailableDateController::class, 'updateUnavailableDatesByUid']);
    });
    Route::post('unavailable_date/getUnavailableDatesById', [UnavailableDateController::class, 'getUnavailableDatesById']);
    ...
    Route::post('event_contract/getById', [EventContractController::class, 'getById']);
    Route::post('event_contract/getSavedEventContracts', [EventContractController::class, 'getSavedEventContracts']);
    Route::post('event_contract/getSavedEventContractsByUid', [EventContractController::class, 'getSavedEventContractsByUid']);
    ...
    Route::post('salon/getBatchDataFromCategories', [SalonController::class, 'getBatchDataFromCategories']);
