...
double fee = double.parse(controller.eventContractData!.fee.toString());
              ...
              child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(
                         controller.eventContractData!.nameVenue.toString(),
                          style: TextStyle(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(
                          controller.eventContractData!.venueMobile.toString(),
                          style: TextStyle(
                            color: ThemeProvider.orangeColor,
                            fontFamily: 'bold',
                            fontSize: 14,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                       ...
                       child:
                        Text(
                          controller.eventContractData!.addressVenue.toString(),
                          style: TextStyle(
                            color: ThemeProvider.orangeColor,
                            fontFamily: 'bold',
                            fontSize: 14,
                ...
                SizedBox(height: 10),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(
                           controller.eventContractData!.paymentMethod.toString(),
                          style: TextStyle(
                            color: ThemeProvider.orangeColor,
                            fontFamily: 'bold',
                            fontSize: 14,
                 ...
                 SizedBox(height: 20),
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            controller.eventContractData!.extraField.toString(),
                            style: TextStyle(
                              color: ThemeProvider.orangeColor,
                              fontFamily: 'bold',
                              fontSize: 14,
                  ...
                  SizedBox(height: 20),
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Wrap(
                            ...
                            spacing: 25.0,
                            runSpacing: 50.0,
                            children: controller.eventContractData!.bodys!.split("/n").map((body) {
                              return Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  // Container(
                          ...
                          // ),
                          // Text(
                          //   "Contract Price ${controller.eventContractData!.fee.toString()}",
                          //   style: TextStyle(
                          ...
                          // ),
                          // Text(
                          //   (controller.eventContractData!.fee! - 20).toString(),
                          //   style: TextStyle(
                          //     color: ThemeProvider.appColor,
                          //     fontFamily: 'bold',
                          //     fontSize: 25,
                  ...
                  Visibility(
                    visible:
                        controller.eventContractData!.status != 'Deleted' &&
                            controller.eventContractData!.suggester == 'user',
                    child: Row(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: controller.eventContractData!.status ==
                              'pending',
                          child: ElevatedButton(
                            onPressed: controller.eventContractData!.status !=
                                    'Declined'
                                ? () {
                                    Navigator.of(context).pop();
                                    controller.updateEventContractStatus(
                                        'Declined', notificationData.id!);
                                        controller.onDeclineContract();
                                        controller.onChat();
