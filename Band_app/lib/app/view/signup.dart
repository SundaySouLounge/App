...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SignUpController>(
      builder: (value) {
        var fixedLatitude = 51.5072;
        var fixedLongitude = 0.1276;
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            "Your Latitude".tr +
                                                ": " +
                                                fixedLatitude
                                                    .toString(), // Replace fixedLatitude with the actual latitude value
                                            style: TextStyle(
                                              fontSize: 14,
                                              color: ThemeProvider.greyColor,
                                            ),
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            "Your Longitude".tr +
                                                ": " +
                                                fixedLongitude
                                                    .toString(), // Replace fixedLongitude with the actual longitude value
                                            style: TextStyle(
                                              fontSize: 14,
                                              color: ThemeProvider.greyColor,
                                            ),
