...
class _ProfileCategoriesState extends State<ProfileCategoriesScreen> {
  String travelEditor = 'YES';
  String? selectedValue; // Use nullable type for selectedValue
   ...
   String selectedWeddingValue = '£300-£600';
   ...
   String selectInstrument = 'Select Instruments';
              ...
              : SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    filled: true,
                                    fillColor: ThemeProvider.whiteColor,
                                    hintText: 'Enter Contact Name'.tr,
                                    hintStyle: const TextStyle(
                                        color: ThemeProvider.greyColor,
                                        fontSize: 12),
                                    contentPadding: const EdgeInsets.only(
                            ...
                            //             ),
                            //           )
                            //           : value.profileInfo.selectedAcusticSoloValueInstrument != null 
                            //             ? AbsorbPointer(
                            //               absorbing: true, // Disable text field editing
                            //               child: TextFormField(
                            //                 controller: value.selectedAcusticSoloValueInstrument,
                            ...
                            //     children: [
                                ...
                                //             ),
                                //           )
                                //           : value.profileInfo.selectedAcusticDuoValue != null 
                                //         ? AbsorbPointer(
                                //             absorbing: true, // Disable text field editing
                                //             child: TextFormField(
                                //               controller: value.selectedAcusticDuoValue,
                                ...
                                //         ),
                                //       )
                                //       : value.profileInfo.selectedAcusticDuoValueInstrument != null 
                                //         ? AbsorbPointer(
                                //             absorbing: true, // Disable text field editing
                                //             child: TextFormField(
                                //               controller: value.selectedAcusticDuoValueInstrument,
                                ...
                                // ),
                                  ...
                                  //                 ),
                                  //               )
                                  //               : value.profileInfo.selectedAcusticTrioValue != null 
                                  //               ? AbsorbPointer(
                                  //                   absorbing: true, // Disable text field editing
                                  //                   child: TextFormField(
                                  //                     controller: value.selectedAcusticTrioValue,
                                  ...
                                  //                 ),
                                  //               )
                                  //               : value.profileInfo.selectedAcusticTrioValueInstrument != null 
                                  //               ? AbsorbPointer(
                                  //                   absorbing: true, // Disable text field editing
                                  //                   child: TextFormField(
                                  //                     controller: value.selectedAcusticTrioValueInstrument,
                                  ...
                                  //                 ),
                                  //               )
                                  //               : value.profileInfo.selectedAcusticQuarterValue != null 
                                  //               ? AbsorbPointer(
                                  //                   absorbing: true, // Disable text field editing
                                  //                   child: TextFormField(
                                  //                     controller: value.selectedAcusticQuarterValue,
                                  ...
                                  //                     ),
                                  //                   )
                                  //                 : value.profileInfo.selectedAcusticQuarterValueInstrument != null 
                                  //                     ? AbsorbPointer(
                                  //                         absorbing: true, // Disable text field editing
                                  //                         child: TextFormField(
                                  //                           controller: value.selectedAcusticQuarterValueInstrument,
                                  ...
                                  //           if (instrumentFour)
                                  //             DropdownButton<String>(
                                  //               value: selectedAcusticQuarterValues.isNotEmpty
                                  //                   ? selectedAcusticQuarterValues.first
                                  //                   : null,
                                  //               onChanged: (String? newValue) {
                                  //                 setState(() {
                                  //                   if (newValue != null) {
                                  ...
                                  //                     // Update the text field with selected values
                                  //                     value.selectedAcusticQuarterValueInstrument.text =
                                  //                         selectedAcusticQuarterValues.join(', ');
                                  //                   }
                                  //                 });
                                  //               },
                                  //               items: dropdownItems.map<DropdownMenuItem<String>>((String value) {
                          ...
                          //                 ),
                          //               )
                          //               : value.profileInfo.weddingEditor != null 
                          //               ? AbsorbPointer(
                          //                   absorbing: true, // Disable text field editing
                          //                   child: TextFormField(
                          //                     controller: value.weddingEditor,
                          ...
                          //             if (showDropdownTwo)
                          //               DropdownButton<String>(
                          //                 value: selectedWeddingValue,
                          //                 onChanged: (String? newValue) {
                          //                   print("Selected value from wedding dropdown: $newValue");
                          //                   setState(() {
                          //                     selectedWeddingValue = newValue ?? '';
                          //                     value.weddingEditor.text = selectedWeddingValue;
                          //                   });

                          //                   // Print the updated value and check if it matches the selected value in the UI
                          //                   print("Updated weddingEditor: $selectedWeddingValue");
                          ...
                          //                         ),
                          //                       )
                          //                     : value.profileInfo.weddingEditorInstrument != null 
                          //                     ? AbsorbPointer(
                          //                         absorbing: true, // Disable text field editing
                          //                         child: TextFormField(
                          //                           controller: value.weddingEditorInstrument,
                      ...
                      //                               minWidth: 0,
                      //                               maxWidth: 200, // Set your desired constraints
                      //                             ),
                      //                             child: Container(
                      //                               child: TextFormField(
                      ...
                      //                           ),
                      //                         )
                      //                       : value.profileInfo.travelEditor != null
                      //                           ? AbsorbPointer(
                      //                               absorbing: true, // Disable text field editing
                      //                               child: TextFormField(
                      //                                 controller: value.travelEditor,
