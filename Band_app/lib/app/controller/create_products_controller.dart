...
import 'package:ultimate_band_owner_flutter/app/backend/models/categories_model.dart';
import 'package:ultimate_band_owner_flutter/app/backend/models/products_model.dart';
...
class CreateProductsController extends GetxController implements GetxService {
  ...
  void onShopSubCategories() {
    if (selectedCateId == '' || selectedCateId.isEmpty) {
      showToast('Please select Genres');
      return;
    }
