                ...
                child: Center(
                  ...
                  children: [
                    Text(
                      ...
                      style:
                          const TextStyle(fontSize: 12, fontFamily: 'medium', color: Colors.white),
                    ),
                    Text(
                      text,
                      style:
                    ...
                    OtpTextField(
                      numberOfFields: 6,
                      borderColor: ThemeProvider.blackColor,
                      keyboardType: TextInputType.number,
                      disabledBorderColor:  ThemeProvider.blackColor,
                      focusedBorderColor: ThemeProvider.redColor,
                      showFieldAsBox: true,
