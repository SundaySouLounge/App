import 'package:ultimate_band_owner_flutter/app/backend/models/language_model.dart';
...
class AppConstants {
  ...
  static const String getSalonByUID = 'api/v1/salon/getByUID';
  ...
  static const String getTimeSlotByUid = 'api/v1/timeslots/getByUid';
  ...
  static const String deletePushNotification = 'api/v1/notification/deletePushNotification';
  ...
  static const String getAllVideos = 'api/v1/freelancer_videos/getAll';
  static const String getMyVideos = 'api/v1/freelancer_videos/getMyVideos';
  static const String getVideosById = 'api/v1/freelancer_videos/getVideosById';
  static const String updateVideo = 'api/v1/freelancer_videos/update';
  static const String removeVideo = 'api/v1/freelancer_videos/remove';
  static const String createVideo = 'api/v1/freelancer_videos/create';
  static const String getVideoById = 'api/v1/freelancer_videos/getVideoById';
  static const String getAllCalendarEvents = 'api/v1/calendar_events/getAll';
  static const String getMyCalendarEvents = 'api/v1/calendar_events/getMyEvents';
  static const String getCalendarEventsById = 'api/v1/calendar_events/getEventsById';
  static const String updateCalendarEvent = 'api/v1/calendar_events/update';
  static const String removeCalendarEvent = 'api/v1/calendar_events/remove';
  static const String createCalendarEvent = 'api/v1/calendar_events/create';
  static const String getCalendarEventById = 'api/v1/calendar_events/getEventById';
  static const String getMyNotificationData = 'api/v1/notification/getMyNotificationData';
  static const String getEventContractById = 'api/v1/event_contract/getById';
  static const String updateEventContractById = 'api/v1/event_contract/update';
  static const String getSavedEventContractsByUid =
      'api/v1/event_contract/getSavedEventContractsByUid';
  static const String getMyEventContracts = 'api/v1/event_contract/getMyEventContracts';
  static const String getUnavailableDatesByUid = 'api/v1/unavailable_date/getUnavailableDatesByUid';
  static const String updateUnavailableDatesByUid = 'api/v1/unavailable_date/updateUnavailableDatesByUid';
